    ...
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-[420px]">
        <Link href="/" className="flex items-center justify-center gap-2 mb-8">
          <div className="w-10 h-10 bg-primary rounded-xl flex items-center justify-center text-white font-black text-lg">M</div>
          <span className="text-xl font-bold text-neutral-900">MarketPlace</span>
        </Link>

        <div className="bg-white rounded-2xl p-8 shadow-card border border-neutral-100">
          <h1 className="text-2xl font-bold text-neutral-900 mb-1">Tạo tài khoản</h1>
          <p className="text-sm text-neutral-500 mb-6">Tham gia cộng đồng MarketPlace</p>
